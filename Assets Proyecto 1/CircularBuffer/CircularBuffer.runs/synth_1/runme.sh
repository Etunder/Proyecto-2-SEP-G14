...
HD_PWD='C:/Users/Amteo/Desktop/Universidad/SEP/Proyecto1/CircularBuffer/CircularBuffer.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log circular_buffer.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source circular_buffer.tcl
