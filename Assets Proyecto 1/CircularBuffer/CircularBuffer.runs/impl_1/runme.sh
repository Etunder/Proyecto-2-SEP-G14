...
HD_PWD='C:/Users/Amteo/Desktop/Universidad/SEP/Proyecto1/CircularBuffer/CircularBuffer.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log circular_buffer.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source circular_buffer.tcl -notrace
