...
HD_PWD='C:/Users/Amteo/Desktop/Universidad/SEP/Proyecto1/IndexSelector/IndexSelector.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log index_selector.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source index_selector.tcl
