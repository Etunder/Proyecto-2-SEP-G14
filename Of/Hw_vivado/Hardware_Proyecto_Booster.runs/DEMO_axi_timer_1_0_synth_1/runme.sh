...
HD_PWD='C:/Users/Amteo/Desktop/Proyecto-2-SEP-G14/Of/Hw_vivado/Hardware_Proyecto_Booster.runs/DEMO_axi_timer_1_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log DEMO_axi_timer_1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source DEMO_axi_timer_1_0.tcl
