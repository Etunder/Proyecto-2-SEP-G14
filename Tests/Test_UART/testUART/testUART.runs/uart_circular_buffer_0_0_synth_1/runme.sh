...
HD_PWD='C:/Users/etien/Desktop/Proyecto-2-SEP-G14/Tests/Test_UART/testUART/testUART.runs/uart_circular_buffer_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log uart_circular_buffer_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source uart_circular_buffer_0_0.tcl
