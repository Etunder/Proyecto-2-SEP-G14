...
module decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix(clk, rst, sample_vector, start, fft_output, 
  fft_processing_done, ROM_data, addr, state_out)
/* synthesis syn_black_box black_box_pad_pin="clk,rst,sample_vector[2047:0],start,fft_output[383:0],fft_processing_done,ROM_data[63:0],addr[9:0],state_out[2:0]" */;
  input clk;
  input rst;
