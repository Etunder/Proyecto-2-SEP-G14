...
module decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix(clk, fft_done, is_done, vector_32_bits, 
  vector_64x32_bits, full_out)
/* synthesis syn_black_box black_box_pad_pin="clk,fft_done,is_done,vector_32_bits[31:0],vector_64x32_bits[2047:0],full_out" */;
  input clk;
  input fft_done;
  output is_done;
