...
--Date        : Thu Jul  4 17:46:59 2024
--Host        : DESKTOP-9CMCGP1 running 64-bit major release  (build 9200)
--Command     : generate_target test_sd.bd
--Design      : test_sd
...
entity test_sd is
  ...
  attribute CORE_GENERATION_INFO of test_sd : entity is "test_sd,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=test_sd,x_ipVersion=1.00.a,x_ipLanguage=VHDL,numBlks=1,numReposBlks=1,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=USER,da_axi4_cnt=1,da_ps7_cnt=1,synth_mode=OOC_per_IP}";
  attribute HW_HANDOFF : string;
  attribute HW_HANDOFF of test_sd : entity is "test_sd.hwdef";
end test_sd;

architecture STRUCTURE of test_sd is
  component test_sd_processing_system7_0_0 is
  port (
  ...
  end component test_sd_processing_system7_0_0;
...
begin
processing_system7_0: component test_sd_processing_system7_0_0
     port map (
