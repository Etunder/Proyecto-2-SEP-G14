...
HD_PWD='C:/Users/etien/Desktop/Proyecto-2-SEP-G14/Tests/Test_SD/Test_SD.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log test_sd_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source test_sd_wrapper.tcl -notrace
