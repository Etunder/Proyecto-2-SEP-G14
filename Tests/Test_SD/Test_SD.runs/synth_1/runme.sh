...
HD_PWD='C:/Users/etien/Desktop/Proyecto-2-SEP-G14/Tests/Test_SD/Test_SD.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log test_sd_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source test_sd_wrapper.tcl
