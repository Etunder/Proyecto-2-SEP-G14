...
HD_PWD='C:/Users/Amteo/Desktop/Universidad/SEP/Proyecto-2-SEP-G14/Tests/AxiFloat/AxiFloat.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log AXI_FLOAT_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source AXI_FLOAT_wrapper.tcl
