...
HD_PWD='C:/Users/Amteo/Desktop/Universidad/SEP/Proyecto-2-SEP-G14/Tests/AxiFloat/AxiFloat.runs/AXI_FLOAT_auto_pc_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log AXI_FLOAT_auto_pc_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source AXI_FLOAT_auto_pc_0.tcl
