...
HD_PWD='C:/Users/Amteo/Desktop/Universidad/SEP/Proyecto-2-SEP-G14/Tests/AxiFloat/AxiFloat.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log AXI_FLOAT_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source AXI_FLOAT_wrapper.tcl -notrace
